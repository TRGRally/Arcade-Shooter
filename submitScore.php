...
if(isset($_POST["name"]) and isset($_POST["score"]) and isset($_POST["timestamp"])){
    ...
    $statement = ("INSERT INTO scores (Player, Score, Timestamp) VALUES (:player, :score, :timestamp)"); //define statement with placeholder values (protect against SQL inj.)
    ...
    $run->bindValue(":timestamp", $_POST["timestamp"], PDO::PARAM_INT); //bind date variable to its placeholder
