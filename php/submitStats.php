...
if(isset($_POST["highscore"]) and isset($_POST["highwave"]) and isset($_POST["gamesplayed"]) and isset($_POST["shotsfired"]) and isset($_POST["username"])){
    ...
    $run->bindValue(":gamesplayed", $_POST["gamesplayed"], PDO::PARAM_INT); //bind games player variable to its placeholder
    $run->bindValue(":shotsfired", $_POST["shotsfired"], PDO::PARAM_INT); //bind shots fired variable to its placeholder
    $run->bindValue(":username", $_POST["username"], PDO::PARAM_STR); //bind username variable to its placeholder
